...
namespace ShoseShop.Controllers
{
    public class KhuyenMaiController : Controller
    {
            ...
            public ActionResult SaleIndex(string searchStringKm, string maMau, int? sortGia, decimal? minPrice, decimal? maxPrice, int phantramgiam)
            {
                CreateData();
                ...
                dongspView = dongspView.Where(x => x.sanpham.ChiTietSanPhams != null).ToList();
        ...
        public ActionResult FindSaleProduct(string searchStringKm, string maMau, int? sortGia, decimal? minPrice, decimal? maxPrice, int phantramgiam)
            {
                CreateData();
                ViewBag.phantramgiam = phantramgiam;
                ViewBag.sortGia1 = sortGia;
