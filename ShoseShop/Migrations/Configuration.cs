namespace ShoseShop.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ShoseShop.Data.ShoesDbContext>
    {
        ...
        protected override void Seed(ShoseShop.Data.ShoesDbContext context)
        {
            ...
            context.Phuongthucthanhtoans.AddOrUpdate(
                p => p.MaPTTT,
            ...
            context.Loais.AddOrUpdate(
                l => l.MaLoai,
                new Data.Loai { MaLoai = 7, TenLoai = "Bóng đá" },
                new Data.Loai { MaLoai = 8, TenLoai = "Bóng rổ" },
                new Data.Loai { MaLoai = 9, TenLoai = "Chạy bộ" }
            ...
            context.Sanphams.AddOrUpdate(
                s => s.MaSanPham,
                new Data.SanPham { MaSanPham = 7 ,Maloai = 7, TenSanPham = "Copa Pure 2 Elite FG",GiaSanPham = 500000 , MoTa = "Giày đá bóng da thật cao cấp với công nghệ Fusionskin liền mạch, ôm chân êm ái, cho cảm giác bóng tối ưu và bám sân chắc chắn trên cỏ tự nhiên" },
                new Data.SanPham { MaSanPham = 8, Maloai = 9 , TenSanPham = "Duramo SL 2.0", GiaSanPham = 1900000, MoTa = "Giày chạy bộ nhẹ, êm ái với đệm LIGHTMOTION và lưới thoáng khí, mang lại cảm giác thoải mái và hỗ trợ tối ưu cho luyện tập hằng ngày." },
                new Data.SanPham { MaSanPham = 9, Maloai = 9, TenSanPham = "Supernova Rise", GiaSanPham = 4000000, MoTa = "Giày chạy bộ hiệu suất cao với đệm Dreamstrike+ êm ái, thiết kế ôm chân và đế ngoài bám tốt, mang lại trải nghiệm êm mượt trên mọi quãng đường." },
                new Data.SanPham { MaSanPham = 10, Maloai = 7, TenSanPham = "Crazyfast Elite", GiaSanPham = 2900000, MoTa = "Giày đá bóng Adidas X Crazyfast Elite FG – thiết kế tối giản siêu nhẹ, upper Aeropacity Speedskin trong suốt, đế Lightstrike cho tăng tốc nhanh chóng, bám sân chắc trên cỏ tự nhiên" },
                new Data.SanPham { MaSanPham = 11, Maloai = 9, TenSanPham = "Rivarly Low", GiaSanPham = 2100000, MoTa = "Sneaker cổ thấp phong cách retro, chất liệu da mềm kết hợp đế cao su bền chắc, mang lại sự thoải mái và dễ phối đồ cho phong cách hằng ngày." },
                new Data.SanPham { MaSanPham = 12, Maloai = 8, TenSanPham = "Nike Air Zoom GT Cut 3", GiaSanPham = 3000000, MoTa = "Giày bóng rổ nhẹ, đệm Zoom Air phản hồi nhanh, bám sân tốt, hỗ trợ di chuyển linh hoạt và tăng tốc." },
                new Data.SanPham { MaSanPham = 13, Maloai = 8, TenSanPham = "Adidas Harden Vol. 8", GiaSanPham = 2000000, MoTa = "hiết kế hiện đại lấy cảm hứng từ James Harden, đệm Lightstrike êm ái, hỗ trợ bứt tốc và đổi hướng mượt mà." }

            );



            context.ChiTietSanPhams.AddOrUpdate(
                s => s.MaChiTietSP,

                new Data.ChiTietSanPham { MaChiTietSP = 1, MaSP = 7, MaMau = 4, AnhDaiDien = "do1.jpg", AnhMatTren = "do2.jpg", AnhDeGiay = "do3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.DangBan },
                 new Data.ChiTietSanPham { MaChiTietSP = 2, MaSP = 7, MaMau = 2, AnhDaiDien = "trang1.jpg", AnhMatTren = "trang2.jpg", AnhDeGiay = "trang3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.New },
                  new Data.ChiTietSanPham { MaChiTietSP = 3, MaSP = 8, MaMau = 2, AnhDaiDien = "trang1.jpg", AnhMatTren = "trang2.jpg", AnhDeGiay = "trang3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.DangBan },
                   new Data.ChiTietSanPham { MaChiTietSP = 4, MaSP = 8, MaMau = 4, AnhDaiDien = "do1.jpg", AnhMatTren = "do2.jpg", AnhDeGiay = "do3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.New },
                   
                   
                   new Data.ChiTietSanPham { MaChiTietSP = 5, MaSP = 9, MaMau = 3, AnhDaiDien = "xanh1.jpg", AnhMatTren = "xanh2.jpg", AnhDeGiay = "xanh3.jpg", Video = "xanh.webm", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.Hot },
                   new Data.ChiTietSanPham { MaChiTietSP = 6, MaSP = 9, MaMau = 4, AnhDaiDien = "do1.jpg", AnhMatTren = "do2.jpg", AnhDeGiay = "do3.jpg", Video = "do.webm", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.Hot },
                   new Data.ChiTietSanPham { MaChiTietSP = 7, MaSP = 9, MaMau = 1, AnhDaiDien = "den1.jpg", AnhMatTren = "den2.jpg", AnhDeGiay = "den3.jpg", Video = "den.webm", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.Hot },


                   new Data.ChiTietSanPham { MaChiTietSP = 8, MaSP = 10, MaMau = 8, AnhDaiDien = "vang1.jpg", AnhMatTren = "vang2.jpg", AnhDeGiay = "vang3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.New },
                   new Data.ChiTietSanPham { MaChiTietSP = 9, MaSP = 10, MaMau = 1, AnhDaiDien = "den1.jpg", AnhMatTren = "den2.jpg", AnhDeGiay = "den3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.New },



                   new Data.ChiTietSanPham { MaChiTietSP = 10, MaSP = 11, MaMau = 2, AnhDaiDien = "trang1.jpg", AnhMatTren = "trang2.jpg", AnhDeGiay = "trang3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.Hot },
                   new Data.ChiTietSanPham { MaChiTietSP = 11, MaSP = 11, MaMau = 1, AnhDaiDien = "den1.jpg", AnhMatTren = "den2.jpg", AnhDeGiay = "den3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.Hot },


                   new Data.ChiTietSanPham { MaChiTietSP = 12, MaSP = 12, MaMau = 2, AnhDaiDien = "trang1.jpg", AnhMatTren = "trang2.jpg", AnhDeGiay = "trang3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.DangBan },
                   new Data.ChiTietSanPham { MaChiTietSP = 13, MaSP = 12, MaMau = 1, AnhDaiDien = "den1.jpg", AnhMatTren = "den2.jpg", AnhDeGiay = "den3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.New },



                   new Data.ChiTietSanPham { MaChiTietSP = 14, MaSP = 13, MaMau = 2, AnhDaiDien = "trang1.jpg", AnhMatTren = "trang2.jpg", AnhDeGiay = "trang3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.New },
                   new Data.ChiTietSanPham { MaChiTietSP = 15, MaSP = 13, MaMau = 1, AnhDaiDien = "den1.jpg", AnhMatTren = "den2.jpg", AnhDeGiay = "den3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.New },
                   new Data.ChiTietSanPham { MaChiTietSP = 16, MaSP = 13, MaMau = 3, AnhDaiDien = "xanh1.jpg", AnhMatTren = "xanh2.jpg", AnhDeGiay = "xanh3.jpg", Video = "", TrangThai = Data.ChiTietSanPham.TrangThaiEnum.DangBan }

                );


            context.Sanphamsizes.AddOrUpdate(
                s => s.MaSanPhamSize,
